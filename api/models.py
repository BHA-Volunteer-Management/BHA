...
class BHAUserManager(BaseUserManager):
...
class BHAUser(AbstractBaseUser, PermissionsMixin):
...
class Volunteer(models.Model):
    user = models.OneToOneField(BHAUser, null=True,on_delete=models.CASCADE)
